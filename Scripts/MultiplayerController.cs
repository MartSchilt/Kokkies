...
{
    public VoiceOrchestrator voice;
    ...
    public override void _Ready()
    {
        ...
        else
        {
            ...
            // Initializing
            voice = new();
            voice.Listen = true; // Makes us able to hear our own microphone input
            voice.Recording = true; // Make sure it records the microphone
            AddChild(voice);

            spinBoxInputThreshold.Value = voice.InputThreshold;
            sliderInputThreshold.Value = voice.InputThreshold;
        }
    }
